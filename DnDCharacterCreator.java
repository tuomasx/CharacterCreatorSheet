...
public class DnDCharacterCreator {
    ...
    public static void main(String[] args) {
        ...
        // Set inputs back to initial values
        clearInputs();
        // Set outputs back to initial values
        //clearOutputs();
        ...
        inputClass = "Barbarian"; 
        // 1 - 20
        inputLevel = 1;
        // Backgrounds: // "Acolyte" 15 gold "Charlatan" 15 "Criminal" 15 "Entertainer" 15 "Folk Hero" 10 "Gladiator" 15 "Guild Artisan" 15 "Guild Merchant" 15 "Hermit" 5 "Knight" 25 "Noble" 25 "Outlander" 10 "Pirate" 10 "Sage" 10 "Sailor" 10 "Soldier" 10 "Urchin" 10 ""
        inputBackground = "Acolyte";

        // 3. Ability Scores 
        // Standard Array Ability scores: 15, 14, 13, 12, 10, 8
        inputStrenght = 15;
        inputDexterity = 14;
        inputConstitution = 13;
        inputIntelligence = 8;
        inputWisdom = 10;
        inputCharisma = 12;
        ...
        inputArmor = "Chain Shirt";
        inputWeapon = "Longsword";
        inputShield = false;
        inputOther = "";
        inputGold = 0;
        ...
        // Calculate output based on user input variables
        calculateOutput();
